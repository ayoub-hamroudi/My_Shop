...
<html lang="en">
<head>
	<title>MyShop - Contacter nous</title>
			...
			<div class="row d-flex mb-5 contact-info">
				...
				<div class="col-md-3 d-flex">
					<div class="info bg-white p-4">
						<p><span>Address:</span> Rue Almorabitine Imm. Casablanca , Maroc</p>
					</div>
				</div>
				<div class="col-md-3 d-flex">
					<div class="info bg-white p-4">
						<p><span>Phone:</span> <a href="tel://1234567920">+212 6 13 18 54 70</a></p>
					</div>
				</div>
				<div class="col-md-3 d-flex">
					<div class="info bg-white p-4">
						<p><span>Email:</span> <a href="mailto:info@yoursite.com">info@MyShop.com</a></p>
					</div>
				</div>
				<div class="col-md-3 d-flex">
					<div class="info bg-white p-4">
						<p><span>Website</span> <a href="#">MyShop.com</a></p>
					</div>
				</div>
			</div>
			<div class="row block-9">
				...
				<div class="col-md-6 d-flex">
					<div>
						...
						<img src="images/logo.png" style="display: block; margin: 0 auto" width="400%" height="100%" alt="">
					</div>
